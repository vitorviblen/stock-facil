  ...
  return (
    <header className="sticky top-0 z-30 flex h-14 items-center justify-between border-b bg-stock-ink px-4 text-white md:hidden">
      <div className="flex items-center gap-2">
        ...
        <span className="text-sm font-bold">Stock Fácil</span>
      </div>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        ...
        <DialogContent className="left-0 top-0 h-screen max-w-[280px] translate-x-0 translate-y-0 gap-0 border-r border-white/10 bg-stock-ink p-0 data-[state=closed]:slide-out-to-left data-[state=open]:slide-in-from-left sm:rounded-none">
